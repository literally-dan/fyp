...
A real-world representation of data encapsulation could be putting a letter inside an envelope, addressing it, stamping it, and then putting that envelope inside a second larger envelope. The second larger envelope can then be addressed, stamped and posted independently.
On receipt of the larger envelope, the one inside can then be taken out and posted which has the effect of concealing that two parties are communicating, and is a good analogy of how encapsulation on a computer network functions.\\
