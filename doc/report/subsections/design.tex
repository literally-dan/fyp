...
*out <- %byte
\end{verbatim}
This is a simple example that will simply print out a byte of the input at a time, but in binary.
...
The idea behind List-Order obfuscation is that data can be stored in the order of a list, and retrieved. This is explained in detail in a later section.
