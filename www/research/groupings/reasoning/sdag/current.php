     ...
     <div id="search">
      <form action="http://www.cs.bham.ac.uk/search/" method="get">
       <div class="sys_textBoxWithRedirect">
        ...
        <div id="navWrap">
<h1>School of Computer Science - Current Work</h1>
</div>        <div id="content">
                    <div id="breadcrumbs">
<a class="sys_0 sys_t3000" href="/">Computer Science</a>&nbsp;/&nbsp;<a href="/research/groupings" class="sys_0 sys_t166">Groupings</a>&nbsp;/&nbsp;<a href="/research/groupings/reasoning" class="sys_0 sys_t166">Reasoning</a>&nbsp;/&nbsp;<a href="/research/groupings/reasoning/sdag" class="sys_0 sys_t166">Sdag</a>&nbsp;/&nbsp;<span>Current</span>
</div>          <div id="mainNav">
...
<li>
<a href="maxtract.php">Mathematical Formula Recognition
</a>
</li>
<li>
<a href="chemical.php">Chemical Document Analysis
</a>
</li>
<li>
<a href="symbolic.php">Symbolic Algebra and Reasoning
</a>
</li>
</ul>
</li>
...
Current Work
</h1><div id="wideContent"><p>From these pages you can see examples of our recent work, including sample input, work flows and the various output we produce. Corresponding papers can be found on our <a href="publications.php">publications</a> page.</p>

<ul>
<li><a href="maxtract.php">Mathematical Formula Recognition</a></li>
<li><a href="chemical.php">Chemical Document Analysis</a></li>
<li><a href="symbolic.php">Symbolic Algebra and Reasoning</a></li>
</ul>
